...
const RideSelector = ({ pickupCoordinates, dropoffCoordinates }) => {
	...
	useEffect(() => {
        ...
        rideDuration =	fetch(
			`https://api.mapbox.com/directions/v5/mapbox/driving/${pickupCoordinates[0]},${pickupCoordinates[1]};${dropoffCoordinates[0]},${dropoffCoordinates[1]}?access_token=pk.eyJ1IjoiZGJ2dTUzMSIsImEiOiJjbDIyaTEzdzkwZDQxM2ptYm4wOHpjY2lzIn0.eDnLit0F4TTbXxkHqn1Iew`
		)
			.then((res) => res.json())
...
const Cart = tw.div`flex p-4 items-center`;
const CarImage = tw.img`h-14 `;
const CarDetails = tw.div`flex-1 ml-4`;
